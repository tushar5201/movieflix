...
export const createSeries = async (req, res) => {
    try {
        const { tmdb, name, story, cast, director, release, distributor, rated, genre, imdb, year, category, sande } = req.body;
        const seasonsandepisodes = JSON.parse(sande);
        // console.log(seasonsandepisodes);
        const series = new Series({ tmdb, name, story, cast, director, release, distributor, rated, genre, imdb, year, category, seasonsandepisodes });
